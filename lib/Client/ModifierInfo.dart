...
class _ModifierInfosState extends State<ModifierInfos> {
  ...
  bool ishide = true, isloading = false;
  File? img;
  ...
  void deleteFileFromFirebaseByUrl(String urlFile) async {
    ...
    storageReferance
        .child("image")
        .child("chaouch2022-04-18%2023%3A43%3A34.936139")
        .delete()
  ...
  void ModifierInfos() {
    ...
    FirebaseFirestore.instance
      ...
      if (cpwd != "" && pwd != "" && pwd == cpwd && pwd.length >= 8) {
        ...
        if (pwd != cpwd) {
          setState(() {
            erreur = "les mot de passe ne sont pas compatible";
          });
        }
        if (pwd.length < 8) {
          setState(() {
            erreur = " mot de passe faible au moins 8 carracteres";
          });
        }
        if (pwd == "" && cpwd == "") {
          setState(() {
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    fit: BoxFit.cover,
                                    image: (UrlImage == "" && img == null)
                                        ? const NetworkImage(
                                        "https://cdn.pixabay.com/photo/2022/04/02/12/29/wild-daffodils-7106921_640.jpg")
                    ...
                    ElevatedButton(
                      onPressed:isloading ? null: () async {
                        ...
                        if (img != null) {
                          ...
                          final mountainsRef =
                          storageRef.child("image/$Nom" + Matricule);
                          try {
